...
def getCoffeeBeanStoreInfo(result):
    # USB : usb_device_handle_win.cc:1048 시스템에 부착된 장치가 작동하지 않습니다. 
    # 오류 해결방법
...
def main():
    ...
    # csv 저장
    # coffeebean_df.to_csv('C:/localRepository/StudyBigData/day03/coffeebean_shop_info2.csv', index=True, encoding='utf-8') 절대경로 (day03 폴더아래에 저장됨)
