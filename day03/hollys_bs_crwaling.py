...
def main():
    ...
    # 판다스 데이터프레임 생성
    columns = ['store','sido','address','phone']
    hollys_df = pd.DataFrame(result, columns = columns)

    # csv 저장
    # hollys_df.to_csv('C:/localRepository/StudyBigData/day03/hollys_shop_info2.csv', index=True, encoding='utf-8') 절대경로 (day03 폴더아래에 저장됨)
